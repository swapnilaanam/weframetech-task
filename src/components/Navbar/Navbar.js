...
const Navbar = () => {
    return (
        <div className="w-full bg-[#15132B] pl-[24px] py-[26px] flex items-center gap-11">
            <div className="w-[220px] h-[60px] rounded-[46px] bg-[#211A75] flex items-center gap-5">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none" className="ml-[38px]">
                    <g clip-path="url(#clip0_2866_5)">
                    ...
                    <defs>
                        <clipPath id="clip0_2866_5">
                            <rect width="28" height="28" fill="white" />
                        </clipPath>
                    </defs>
                </svg>
                <input type="search" className="w-[50%] font-medium bg-[#211A75] text-[#AAA]" placeholder="Search here" />
            </div>
            <Link href={""} className="text-[#6418C3] underline font-bold">OTHER MENUS</Link>
            <div className="flex gap-8">
                <div className="relative">
                    ...
                    <div className="w-7 h-7 rounded-full bg-[#5ECFFF] flex justify-center items-center text-sm font-bold absolute -top-4 -right-3">12</div>
                </div>
                <div className="relative">
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                        <g clip-path="url(#clip0_2866_45)">
                        ...
                        <defs>
                            <clipPath id="clip0_2866_45">
                                <rect width="28" height="28" fill="white" transform="translate(-0.000244141)" />
                            </clipPath>
                        </defs>
                    </svg>
                    <div className="w-7 h-7 rounded-full bg-[#5ECFFF] flex justify-center items-center text-sm font-bold absolute -top-4 -right-3">5</div>
                </div>
                <div className="relative">
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                    ...
                    <div className="w-7 h-7 rounded-full bg-[#5ECFFF] flex justify-center items-center text-sm font-bold absolute -top-4 -right-3">2</div>
                </div>
                <div className="relative">
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                    ...
                    <div className="w-7 h-7 rounded-full bg-[#E328AF] border-[3px] border-[#15132B] flex justify-center items-center text-sm font-bold absolute -top-4 -right-3">
                        !
                    </div>
                </div>
            </div>
            <div className="flex items-center gap-6">
                <div className="flex items-center gap-3 bg-[#211A75] py-5 pl-5 pr-7 rounded-[46px]">
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                        <g clip-path="url(#clip0_2866_13)">
                        ...
                        <defs>
                            <clipPath id="clip0_2866_13">
                                <rect width="28" height="28" fill="white" />
                            </clipPath>
                        </defs>
                    </svg>
                    <div className="text-white font-bold uppercase">English</div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="8" viewBox="0 0 15 8" fill="none">
                        <path d="M0 0H15L7.5 8L0 0Z" fill="#6418C3" />
                    </svg>
                </div>
                <div className="w-[1px] h-14 bg-[#1E1C3A]"></div>
                <div className="flex items-center gap-6 text-white">
                    ...
                    <div>
                        <h4 className="font-bold">Instructor Dev</h4>
                        <h6 className="text-sm text-[#7879F1]">Super Admin</h6>
                    </div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="8" viewBox="0 0 15 8" fill="none">
                        <path d="M0 0H15L7.5 8L0 0Z" fill="#6418C3" />
                    </svg>
